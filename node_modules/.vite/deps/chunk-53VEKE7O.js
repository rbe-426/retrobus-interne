import {
  require_react_dom
} from "./chunk-EW5TPEOM.js";
import {
  styled
} from "./chunk-MZDLZEGV.js";
import {
  Global,
  ThemeContext,
  ThemeProvider,
  ...
  _extends,
  keyframes
} from "./chunk-NDEKAVOD.js";
import {
  AnimatePresence,
  motion,
  useIsPresent,
  usePresence
} from "./chunk-54G3HKIM.js";
import {
  require_jsx_runtime
} from "./chunk-EWBH63Y5.js";
import {
  require_react
} from "./chunk-VGLFF4QM.js";
import {
  __commonJS,
  __toESM
...
function addPointerEvent(target, type, cb, options2) {
  return addDomEvent(target, type, wrap(cb, type === "pointerdown"), options2);
}
...
function useFocusOnShow(target, options2 = defaultOptions) {
...
function useSize(subject, options2) {
  const { observeMutation = false, enabled, fallback } = options2 ?? {};
...
function cssVar2(name, options2) {
  const cssVariable = toVar(name, options2?.prefix);
  return {
    variable: cssVariable,
    reference: toVarRef(cssVariable, getFallback(options2?.fallback))
  };
}
...
function getColorModeUtils(options2 = {}) {
  const { preventTransition = true, nonce } = options2;
  const utils = {
    setDataset: (value) => {
...
function styled2(component, options2) {
  const { baseStyle: baseStyle44, ...styledOptions } = options2 ?? {};
...
function createRenderToast(options2 = {}) {
  ...
  const renderToast = (props) => {
    ...
    return (0, import_jsx_runtime16.jsx)(ToastComponent2, { ...props, ...options2 });
  };
  return renderToast;
}
...
function createToast(message, options2 = {}) {
  counter += 1;
  const id = options2.id ?? counter;
  const position2 = options2.position ?? "bottom";
  return {
    id,
    message,
    position: position2,
...
var DescendantsManager = class {
  constructor() {
    ...
    __publicField2(this, "registerNode", (node2, options2) => {
...
function createDescendantContext() {
  ...
  const useDescendant = (options2) => {
    ...
    const refCallback = options2 ? cast2(descendants.register(options2)) : cast2(descendants.register);
    return {
      descendants,
      index,
...
function getSlideTransition(options2) {
  const side = options2?.direction ?? "right";
  switch (side) {
    case "right":
...
function getByTypeaheadImpl(_items, options2) {
  const { state: state2, activeId, key, timeout = 350 } = options2;
...
var defaultOptions2 = function(options2) {
...
var moveFocus = function(fromElement, options2, cb) {
  ...
  var newOptions = defaultOptions2(options2);
...
function createIcon(options2) {
  ...
  const path = import_react84.Children.toArray(options2.path);
...
function useColorModePreference(options2) {
  ...
  return function createPopper4(reference2, popper2, options2) {
    ...
    var instance = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        state2.options = Object.assign({}, defaultOptions3, state2.options, options3);
    ...
    function runModifierEffects() {
      state2.orderedModifiers.forEach(function(_ref2) {
        var name = _ref2.name, _ref$options = _ref2.options, options3 = _ref$options === void 0 ? {} : _ref$options, effect5 = _ref2.effect;
...
function useEventListeners() {
  ...
  const add3 = (0, import_react90.useCallback)((el, type, listener, options2) => {
...
function getStyles3(options2) {
  const { orientation, thumbPercents, isReversed } = options2;
...
function createToastFn(dir, defaultOptions3) {
  const normalizeToastOptions = (options2) => ({
    ...
    position: getToastPlacement(
      options2?.position ?? defaultOptions3?.position,
      dir
    )
  });
  ...
  toast.update = (id, options2) => {
    toastStore.update(id, normalizeToastOptions(options2));
  };
...
function useToast(options2) {
  ...
  return (0, import_react131.useMemo)(
    ...
    [options2, theme2.direction, defaultOptions3]
  );
}
...
//# sourceMappingURL=chunk-53VEKE7O.js.map
