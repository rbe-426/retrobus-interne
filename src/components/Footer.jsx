  ...
  return (
    ...
    >
      <Container maxW="6xl" px={isMobile ? 2 : undefined}>
        {/* Section principale */}
        <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={isMobile ? 6 : 4} mb={isMobile ? 6 : 4}>
          {/* Logo et À propos */}
          ...
          <VStack align="start" spacing={isMobile ? 3 : 2}>
            ...
            <Link href="https://association-rbe.fr" _hover={{ color: hoverColor }} fontSize={isMobile ? "xs" : "sm"} target="_blank" rel="noopener noreferrer" minH={isMobile ? "44px" : "auto"} display="flex" alignItems="center">
          ...
          <VStack align="start" spacing={isMobile ? 3 : 2}>
            ...
            <HStack spacing={isMobile ? 6 : 4} wrap="wrap">
              {/* Facebook */}
              <Link
        ...
        <VStack spacing={isMobile ? 3 : 2} align="stretch">
          <SimpleGrid columns={{ base: 1, md: 2 }} spacing={isMobile ? 4 : 3} fontSize={isMobile ? "2xs" : "xs"}>
            ...
            <HStack justify={{ base: 'center', md: 'end' }} spacing={isMobile ? 3 : 4} wrap="wrap">
              <Link href="/statuts.pdf" _hover={{ color: hoverColor }} minH={isMobile ? "44px" : "auto"} display="flex" alignItems="center">
                Mentions légales
              </Link>
              <Link href="/rgpd.pdf" _hover={{ color: hoverColor }} minH={isMobile ? "44px" : "auto"} display="flex" alignItems="center">
                RGPD
              </Link>
