/**
 * EditDevisWizard.jsx
 * Wizard 3 étapes pour ÉDITER un DEVIS existant
 * Édition: Infos → Lignes & Montants → Vérification
 */
...
export default function EditDevisWizard({ editingDocument, onSave = () => {}, onClose = () => {} }) {
  ...
  const stepsComplete = [isStep1Complete, isStep2Complete, isStep3Complete];
  ...
  const renderStep1 = () => (
    <VStack spacing={4} align="stretch">
      <Alert status="info" borderRadius="md">
        <AlertIcon />
        <Text>Modifiez les informations du devis</Text>
      </Alert>
