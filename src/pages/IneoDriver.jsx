...
export default function IneoDriver() {
  ...
  if (!mission) return <Container maxW="md" py={8}><Box bg="white" borderLeft="4px solid" borderColor="rbe.500" p={5}><HStack align="start"><Icon as={FiClock} boxSize={6} color="rbe.600" /><VStack align="start" spacing={1}><Heading size="sm">Aucun service à prendre</Heading><Text fontSize="sm" color="gray.600">Votre prochain service apparaîtra ici dès son affectation.</Text></VStack></HStack></Box></Container>;
