...
import {
  FiActivity, FiChevronDown, FiClock, FiHash, FiMap, FiMapPin, FiPlus,
  FiRefreshCw, FiSmartphone, FiTruck, FiUser
} from 'react-icons/fi';
...
function MissionTable({ loading, missions, members = [], onChangeDriver, compact = false }) {
  ...
  return <Box overflowX="auto" border="1px solid" borderColor="#c6d0d8"><Table size="sm"><Thead bg="#e9eff3"><Tr><Th>Etat</Th><Th>Service</Th><Th>Code service</Th><Th>Code course</Th><Th>Vehicule</Th>{!compact && <><Th>Conducteur</Th><Th>Depart prevu</Th><Th>Arrivee prevue</Th></>}{compact && <Th>Position</Th>}</Tr></Thead><Tbody>{missions.map((mission) => {
